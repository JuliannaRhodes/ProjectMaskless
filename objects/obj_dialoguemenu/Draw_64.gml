...
for (var i = 0; i < op_length; i++) {
    var _op_w = string_width(ChatterboxGetOption(obj_pc1.chatterbox, i));
    _new_w = max(_new_w, _op_w);
}
width = _new_w + op_border*2;
height = op_border*2 + string_height(ChatterboxGetOption(obj_pc1.chatterbox, 0)) + (op_length-1)*op_space;
