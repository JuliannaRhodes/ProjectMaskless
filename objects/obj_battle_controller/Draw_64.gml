...
if (battle_phase == BattlePhase.MENU) {
    ...
    var bottom_y = gui_h - 250;
    var bottom_h = 200;

    // --- Left textbox (instructions) ---
    var left_x = side_padding;
    var left_w = (gui_w * 0.86) - side_padding;
    var left_y = bottom_y;
    var left_h = bottom_h;
    ...
    var right_w = (gui_w * 0.13) - side_padding;
    var right_x = gui_w - right_w - side_padding;
    ...
    draw_sprite_stretched(spr_fight_menu, 0, right_x, right_y, right_w, right_h);
	  ...
	  // --- Menu option layout ---
	var padding_x = 40;
	var line_height = 35; // make this smaller for closer spacing
	var total_menu_height = array_length(menu_options) * line_height;

	// Vertically center all options inside the right box
...
if (battle_phase == BattlePhase.RHYTHM) {
    ...
    var top_padding_x = 20 + side_padding;
...
var left_x = side_padding;
var left_w = (gui_w * 0.87) - side_padding;
var left_y = bottom_y;
var left_h = bottom_h;
